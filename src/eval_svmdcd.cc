...
int main(int argc, char **argv) {
  ...
  param.model_type = toybox::DCD_BIN_L1;
  param.T = 10;
  param.C = 1.0;
  param.verbose = false;
  ...
  toybox::SVMDCD *classifier = new toybox::SVMDCD();
